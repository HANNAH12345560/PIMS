...
namespace PIMS
{
    public partial class Prescription : Form
    {
        ...
        public Prescription(int consultationId, int patientId, int physicianEvaluationId, double totalPrice)
        {
        ...
        {
            this.Hide();
            Insurance i = new Insurance(consultationId, patientId, totalPrice);
            i.ShowDialog();
            this.Close();
        }
