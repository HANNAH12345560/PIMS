    ...
    "pm.balance_due, pm.philhealth_discount, pm.sc_pwd_discount, pm.other_discount, pm.insurance_payment;";
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        dataGridView1.Rows[2].Cells[2].Value = dr["insurance_payment"].ToString() == "0" ? "---" : string.Format("₱ {0:n0}", dr["insurance_payment"]);
                        dataGridView1.Rows[3].Cells[2].Value = dr["philhealth_discount"].ToString() == "0" ? "---" : string.Format("₱ {0:n0}", dr["philhealth_discount"]);
                        dataGridView1.Rows[4].Cells[2].Value = dr["sc_pwd_discount"].ToString() == "0" ? "---" : string.Format("₱ {0:n0}", dr["sc_pwd_discount"]);
                        dataGridView1.Rows[5].Cells[2].Value = dr["other_discount"].ToString() == "0" ? "---" : string.Format("₱ {0:n0}", dr["other_discount"]);
                    }
                }
            }
        }
